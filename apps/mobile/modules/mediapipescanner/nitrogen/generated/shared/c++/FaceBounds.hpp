...
namespace margelo::nitro::anonymous::mediapipescanner {
  ...
  public:
    FaceBounds() = default;
    explicit FaceBounds(double x, double y, double width, double height): x(x), y(y), width(width), height(height) {}
...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::anonymous::mediapipescanner::FaceBounds> final {
    static inline margelo::nitro::anonymous::mediapipescanner::FaceBounds fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::anonymous::mediapipescanner::FaceBounds(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::anonymous::mediapipescanner::FaceBounds& arg) {
