...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::anonymous::mediapipescanner::Landmark> final {
    static inline margelo::nitro::anonymous::mediapipescanner::Landmark fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::anonymous::mediapipescanner::Landmark(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::anonymous::mediapipescanner::Landmark& arg) {
